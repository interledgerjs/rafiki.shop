...
export const OpenPaymentsLogo = ({size}: LogoProps) => {
  return (
    <svg className={`w-${size} h-${size}`} viewBox="0 0 589 589" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path fillRule="evenodd" clipRule="evenodd"
            d="M587.335 263C576.17 158 509.824 69.4817 417.852 27H332V97.3168C414.339 113.232 478.686 179.619 491.565 263H587.335Z"
            fill="#F59297"></path>
      <path fillRule="evenodd" clipRule="evenodd"
            d="M159 556.045V441.714C150.068 433.57 141.877 424.628 134.539 415H64V477.821C89.7139 510.11 122.07 536.874 159 556.045Z"
            fill="#8FD1C1"></path>
      <path fillRule="evenodd" clipRule="evenodd"
            d="M587.541 265H491.864C493.219 274.404 493.921 284.019 493.921 293.798C493.921 323.364 487.509 351.433 476 376.69V415H563.299C579.813 378.218 589 337.432 589 294.5C589 284.544 588.506 274.702 587.541 265Z"
            fill="#FABD84"></path>
      <path fillRule="evenodd" clipRule="evenodd"
            ...
            fill="#FCC9B3"></path>
      <path fillRule="evenodd" clipRule="evenodd"
            d="M575.471 383C537.897 502.404 426.311 589 294.5 589C282.485 589 270.638 588.28 259 586.882V490.906C270.301 492.887 281.929 493.921 293.798 493.921C372.27 493.921 440.194 448.754 472.99 383H575.471Z"
            fill="#7FC78C"></path>
      <path fillRule="evenodd" clipRule="evenodd"
            ...
            fill="#459789"></path>
      <path fillRule="evenodd" clipRule="evenodd"
            d="M20.2365 402H87V231H6.86334C2.3689 251.451 0 272.699 0 294.5C0 332.436 7.17291 368.697 20.2365 402Z"
            fill="#9EC7D0"></path>
      <path fillRule="evenodd" clipRule="evenodd"
            ...
            fill="#51797D"></path>
      <path fillRule="evenodd" clipRule="evenodd"
            d="M304 0.15033C300.846 0.0503693 297.679 0 294.5 0C185.184 0 89.7794 59.5603 38.9666 148H156.712C192.525 114.314 240.751 93.6746 293.798 93.6746C297.219 93.6746 300.621 93.7605 304 93.9302V0.15033Z"
            fill="#978AA4"></path>
      <path fillRule="evenodd" clipRule="evenodd"
      ...
      <path fillRule="evenodd" clipRule="evenodd"
            ...
            fill="#F47F5F"></path>
      <path fillRule="evenodd" clipRule="evenodd"
            d="M558.041 162.915C556.034 162.972 554.02 163 552 163C453.695 163 371.092 95.7729 347.656 4.78479C440.002 21.6187 517.321 81.5195 558.041 162.915Z"
            fill="#CE6564"></path>
      <path fillRule="evenodd" clipRule="evenodd"
...
export const OpenPaymentsButton: React.FC<Props>=  ({className, onClick, loading}) => {
  ...
  return (
    <div onClick={onClick} className="flex my-auto w-full justify-center px-4 h-12 bg-white rounded shadow cursor-pointer hover:bg-gray-100">
      {
        isLoading
          ?
          ...
          <div className="my-auto flex">
            ...
            <div className="flex my-auto ml-2 font-bold" style={{color: '#1e3250', fontFamily: 'Rubik,sans-serif'}}> Open Payments</div>
          </div>
      }
    </div>
  )
