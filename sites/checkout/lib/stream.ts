...
export async function payment(url: string, accessToken: string, amount: string, destinationAccount: string, sharedSecret: string): Promise<any> {
  try {
...
export async function queryPaymentPointer(paymentPointer: string): Promise<SPSPResponse> {
